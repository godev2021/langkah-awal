...
VALUES
    (1, 'Alfian Purnomo', 'NIK001', NULL, 'Senior Frontend Engineer', 'Senior', 'Product Development & Operation', 'Frontend Engineering', true, false),
    (2, 'Fajar Rifai', 'NIK002', 1, 'Backend Engineer', 'Senior Associate', 'Product Development & Operation', 'Backend Engineer', true, false),
    (3, 'Asep Hidayat', 'NIK003', 2, 'Senior Backend Engineer', 'Senior', 'Product Development & Operation', 'Backend Engineer', true, false),
    (4, 'Ayunindya Annistri', 'NIK004', 2, 'Digital Marketing Specialist', 'Specialist', 'Data Management', 'Digital Marketing', true, false),
    (5, 'Rizka Indah Mahendiyanti', 'NIK005', 1, 'Project Administrator', 'Associate', 'Corporate Strategy', 'Project Management', true, false),
    (6, 'Bayu Utomo', 'NIK006', 1, 'System Analyst', 'Senior', 'Product Development & Operation', 'Backend Engineering', true, false),
    (7, 'Yosa Kresnandya Diputra', 'NIK007', 3, 'Content Writer', 'Associate', 'Data Management', 'Digital Marketing', true, false),
    (8, 'Hamal Fauzi', 'NIK008', 4, 'BI Analyst', 'Senior Associate', 'Corporate Strategy', 'Business Intelligence', true, false),
    (9, 'Mochammad Andri Andaru', 'NIK009', 1, 'Site Reliability Engineer', 'Senior', 'Infrastructure', 'Platform Engineering', true, false),
    (10, 'Keyko Nabila', 'NIK010', 5, 'UI Designer', 'Associate', 'Product Development & Operation', 'Frontend Engineering', true, false),
    (11, 'Hendrawan', 'NIK011', NULL, 'Lead Backend Engineer', 'Specialist', 'Product Development & Operation', 'Backend Engineering', true, false),
    (12, 'Ayu Lestari', 'NIK012', 11, 'Digital Marketing Specialist', 'Senior', 'Data Management', 'Digital Marketing', true, false),
    (13, 'Budi Santoso', 'NIK013', 11, 'Project Administrator', 'Senior Associate', 'Corporate Strategy', 'Project Management', true, false),
    (14, 'Dian Sari', 'NIK014', 11, 'Lead Frontend Engineer', 'Specialist', 'Product Development & Operation', 'Frontend Engineering', false, false),
    (15, 'Hisyam Maulana', 'NIK015', 11, 'Backend Engineer', 'Associate', 'Product Development & Operation', 'Backend Engineering', false, false),
    (16, 'Rina Wulandari', 'NIK016', 11, 'UI/UX Designer', 'Associate', 'Product Development & Operation', 'Frontend Engineering', true, false),
    (17, 'Eko Prasetyo', 'NIK017', 11, 'QA Engineer', 'Senior', 'Product Development & Operation', 'Quality Assurance', true, false),
    (18, 'Siti Nurhaliza', 'NIK018', 12, 'Content Strategist', 'Associate', 'Data Management', 'Digital Marketing', true, false),
    (19, 'Yudi Permana', 'NIK019', 11, 'DevOps Engineer', 'Senior Associate', 'Infrastructure', 'Platform Engineering', true, false),
    (20, 'Linda Oktaviani', 'NIK020', 13, 'Business Analyst', 'Senior', 'Corporate Strategy', 'Project Management', true, false);
...
VALUES
--     (1, 3, 4.1, 'Konsisten deliver fitur di aplikasi mobile.', 'Cepat beradaptasi dengan framework baru.', 'Perlu peningkatan dokumentasi kode.', 'peer'),
    ...
    (10, 2, 3.8, 'Desain UI clean dan konsisten.', 'Detail-oriented.', 'Butuh belajar desain sistem secara end-to-end.', 'peer'),
